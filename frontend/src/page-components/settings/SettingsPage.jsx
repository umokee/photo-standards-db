...
import { ROLES, SETTINGS_TABS } from "../../utils/constants.ts";
import UserCreateModal from "../../pages/settings/UserCreateModal.jsx";
import UserUpdateModal from "../../pages/settings/UserUpdateModal.jsx";
              ...
              >
                {filtered.map((user) => (
                  <div key={user.id} className="users-card__body-item">
                    ...
                    <div>{ROLES.find((r) => r.value === user.role).label}</div>
